...
import type { Podcast, PodcastsCarouselBlock as Props } from '@/payload-types'
...
type ClientProps = Props & { podcasts: Podcast[] }

export const PodcastsCarouselClient: React.FC<ClientProps> = ({
  heading,
  linkLeadText,
  linkAccentText,
  linkUrl,
